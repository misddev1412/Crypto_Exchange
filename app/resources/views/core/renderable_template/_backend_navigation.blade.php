<li class="individual-menu-item">
    <div class="innermenu">
        ...
        <div class="innermenubody">
            ...
            @else
                <p class="pt-3"><label>{{ __('Route: :route', ['route'=> $row['route']]) }}</label></p>
            @endif
            <div class="row">
                <div class="col-sm-6">
            ...
            <p class="mt-2"><label for=""></label><input type="checkbox" class="newwindow"{{$row['new_tab']==1 ? ' checked' : ''}}><em>{{ __('Open link in a new window/tab') }}</em></p>
