...
<div class="form-row">
    ...
    <div class="col">
        ...
        <div class="form-group mb-3">
            ...
            {{ Form::select('country_id', $countries, null,['class' => form_validation($errors, 'country_id'),'id' => 'country_id', 'placeholder' => __('Select Stock Item Type')]) }}
...
<div class="form-group mb-3">
    ...
    <span class="invalid-feedback" data-name="account_holder_address">{{ $errors->first('account_holder_address') }}</span>
</div>
