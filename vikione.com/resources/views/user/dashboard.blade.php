    ...
    <div class="modal-dialog modal-dialog-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="panel pricing-table">
                ...
                <img src="{{asset('images/placeholders/invest.png')}}" alt="" class="pricing-img">
                    <h2 class="pricing-header">Invest</h2>
                    <ul class="pricing-features">
                        <li class="pricing-features-item">Custom domains</li>
                        <li class="pricing-features-item">Sleeps after 30 mins of inactivity</li>
                    </ul>
                    <a href="javscript:;" data-toggle="modal" data-target="#addTnx" class="pricing-button">SELECT</a>
                </div>
                <div class="pricing-plan">
                    <img src="{{asset('images/placeholders/125.png')}}" alt="" class="pricing-img">
                    <h2 class="pricing-header">Sell One</h2>
                    <ul class="pricing-features">
                        <li class="pricing-features-item">Never sleeps</li>
                        <li class="pricing-features-item">Multiple workers for more powerful apps</li>
                    </ul>
                    <a href="javscript:;" data-toggle="modal" data-target="#sellOne" class="pricing-button is-featured">SELECT</a>
                </div>
                <div class="pricing-plan">
                    <img src="{{asset('images/placeholders/cashback.png')}}" alt="" class="pricing-img">
                    <h2 class="pricing-header">Sell Goods</h2>
                    <ul class="pricing-features">
                        <li class="pricing-features-item">Dedicated</li>
                        <li class="pricing-features-item">Simple horizontal scalability</li>
                    </ul>
                    <a href="javscript:;"data-toggle="modal" data-target="#addSellGoods" class="pricing-button">SELECT</a>
                </div>
            </div>
        </div>
        {{-- .modal-content --}}
